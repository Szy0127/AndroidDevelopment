...
public class Clock extends View {
    ...
    private void drawHoursValues(Canvas canvas) {
        ...
        for(int i=1;i<=12;i++)
        {
            float[] location = getPointerHeadXY(PANEL_RADIUS-150,i*5*UNIT_DEGREE);
            canvas.drawText(String.valueOf(i),location[0]-40,location[1]+40,paint);
        }
        ...
        String hour = String.valueOf(nowHours);
        String minute = String.valueOf(nowMinutes);
        String second = String.valueOf(nowSeconds);
        if(hour.length()==1)
        {
            hour = "0"+hour;
        }
        ...
        canvas.drawText(hour+":"+minute+":"+second,mCenterX-200,mCenterY+200,paint);
    ...
    private void drawNeedles(final Canvas canvas) {
        ...
        int nowHours = now.getHours();
        //Toast.makeText(this.getContext(),String.valueOf(now),Toast.LENGTH_SHORT).show();
        int nowMinutes = now.getMinutes();
        int nowSeconds = now.getSeconds();
        // 画秒针
    ...
    private void drawPointer(Canvas canvas, int pointerType, int value) {
        ...
        switch (pointerType) {
            ...
            case 1:
                // todo 3: 画分针，设置分针的颜色
                degree = value * UNIT_DEGREE;
                mNeedlePaint.setColor(0xFFBB86FC);
                pointerHeadXY = getPointerHeadXY(MINUTE_POINTER_LENGTH, degree);
                break;
            case 2:
                degree = value * UNIT_DEGREE;
                mNeedlePaint.setColor(0xFF03DAC5);
        ...
        Log.e("draw", String.valueOf(pointerHeadXY[0])+" "+String.valueOf(pointerHeadXY[1]));
    }
